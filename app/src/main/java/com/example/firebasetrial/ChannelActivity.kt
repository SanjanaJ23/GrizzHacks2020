...
import com.example.firebasetrial.databinding.ActivityChannelBinding
...
class ChannelActivity : AppCompatActivity(), PermissionRequestListener {
    ...
    companion object {
        ...
        private const val EXTRA_CHANNEL_TYPE = "com.example.firebasetrial.CHANNEL_TYPE"
        private const val EXTRA_CHANNEL_ID = "com.example.firebasetrial.CHANNEL_ID"
